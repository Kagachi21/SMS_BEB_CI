        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <form action="<?= base_url('dashboard/absen/store_harian') ?>" method="post">
            <?php
            $d = $_POST;
            if(isset($d['jenis'])){
              if($d['jenis'] == 'pulang'){
                // if($pulang){
                  $this->load->view('backend/content/absensi/pulang');
                // }else{
                //   echo "anda tidak dapat mengisi absen pulang";
                // }
              }else{
                // if($datang){
                  $this->load->view('backend/content/absensi/kehadiran');
                // }else{
