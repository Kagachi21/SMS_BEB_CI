...
<footer class="sticky-footer bg-white">
  ...
  $(document).ready(function() {
    ...
    $("#jam").change(function(){
      ...
      $.ajax({
            type: "GET",
            url: base_url+ "site/cekJadwal/"+kelas+"/"+hari+"/"+jam,
            cache: false,
            success: function(data){
               console.log(data);
               if(data != ""){
    ...
    $("#kelas").change(function(){
      ...
      $.ajax({
            type: "GET",
            url: base_url+ "site/getSiswa/"+id_kelas,
            cache: false,
            success: function(data){
    ...
    $("#kelas_change").change(function(){
      ...
      $.ajax({
            type: "GET",
            url: base_url+ "site/getMapel/"+kelas,
            cache: false,
            success: function(data){
                var obj = JSON.parse(data);
                // console.log(data)
                ...
                for (let index = 0; index < obj.length; index++) {
                    appendElement += "<option  value="+obj[index]['id']+">"+
                                obj[index]['nama']+"["+obj[index]['jurusan']+"]"+
                            "</option>";
                }
    ...
    $("#hari").change(function(){
      ...
      var kelas = $("#kelas_change").val();
      var val = $(this).val();
      console.log( base_url+ "site/getjam/"+val+"/"+mapel+"/"+kelas);
      $.ajax({
            type: "GET",
            
            url: base_url+ "site/getjam/"+val+"/"+mapel+"/"+kelas,
            cache: false,
            success: function(data){
                var obj = JSON.parse(data);
                console.log(data)
